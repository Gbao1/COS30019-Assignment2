...
class GRUTrafficModel(BaseTrafficModel):
    ...
    def __init__(self, units: int = 64, dropout: float = 0.2, **kwargs):
        ...
        """
        super().__init__("GRU", units=units, dropout=dropout, **kwargs)

        if not TENSORFLOW_AVAILABLE:
            raise ImportError("TensorFlow is required for GRU model. Please install: pip install tensorflow")
    ...
    def save_model(self, filepath: str) -> None:
        ...
        print(f"GRU model saved to {model_path} and {filepath}")
    ...
    def load_model(self, filepath: str) -> None:
        ...
        print(f"GRU model loaded from {model_path} and {filepath}")